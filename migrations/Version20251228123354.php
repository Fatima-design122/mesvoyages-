 ...
 */
final class Version20251228123354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite ADD image_name VARCHAR(255) DEFAULT NULL, ADD image_size INT DEFAULT NULL, ADD update_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE ville ville VARCHAR(50) NOT NULL, CHANGE datecreation datecreation DATETIME NOT NULL, CHANGE note note INT NOT NULL, CHANGE avis avis LONGTEXT DEFAULT NULL, CHANGE tempmin tempmin VARCHAR(255) NOT NULL, CHANGE tempmax tempmax VARCHAR(255) NOT NULL, ADD PRIMARY KEY (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite DROP image_name, DROP image_size, DROP update_at, CHANGE id id INT NOT NULL, CHANGE ville ville VARCHAR(50) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_general_ci`, CHANGE tempmin tempmin INT DEFAULT NULL, CHANGE tempmax tempmax INT DEFAULT NULL, CHANGE note note INT DEFAULT NULL, CHANGE datecreation datecreation DATE DEFAULT NULL, CHANGE avis avis TEXT DEFAULT NULL');
    }
}
