 ...
 */
final class Version20251228144406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX id ON environnement');
        $this->addSql('ALTER TABLE environnement CHANGE id id INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE environnement MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE environnement DROP INDEX primary, ADD UNIQUE INDEX id (id)');
        $this->addSql('ALTER TABLE environnement CHANGE id id INT NOT NULL');
