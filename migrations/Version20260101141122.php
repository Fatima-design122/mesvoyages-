 ...
 */
final class Version20260101141122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite ADD updated_at DATETIME DEFAULT NULL, DROP image_size, DROP update_at, CHANGE date_depart date_depart DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite ADD image_size INT DEFAULT NULL, ADD update_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', DROP updated_at, CHANGE date_depart date_depart DATETIME NOT NULL');
